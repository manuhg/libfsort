...
// using namespace cv;
// using namespace std;
// vector<vector<double>> tsne_wrapper::run(vector<string> image_files,int
// op_dims,int max_iters, double perplexity,int num_threads,double theta, bool
// normalize)
// {
//     Mat image; vector<vector<double>> points;
//     for(vector<string>::iterator
//     i=image_files.begin();i!=image_files.end();i++)
//     {
...
//         for display. imshow( "Display window", image );
//     }
//     return points;
// }
...
tsne_wrapper::~tsne_wrapper() { finish(); }
